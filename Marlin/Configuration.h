 ...
 */
#define Z_STEPS      541 // Stock lead screw
...
#define STRING_CONFIG_H_AUTHOR "(pf, TEVO Tarantula config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_FUNCTIONAL_RANGE 25  // If the temperature difference between the target temperature and the actual temperature
                                  // is more than PSID_FUNCTIONAL_RANGE then the PID will be shut off and the heater will be set to min/max.
